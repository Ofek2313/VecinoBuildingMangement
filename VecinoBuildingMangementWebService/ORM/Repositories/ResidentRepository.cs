...
namespace VecinoBuildingMangementWebService
{
    public class ResidentRepository : Repository, IRepository<Resident>
    {
        ...
        public bool Create(Resident model)
        {
            ...
            this.dbHelperOleDb.AddParameter("@UnitNumber", model.UnitNumber.ToString());
        ...
        {
            string sql = "SELECT ResidentName,UnitNumber,ResidentPhone,ResidentEmail From Resident Where BuildingId = @BuildingId";
